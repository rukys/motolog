...
type Props = StackScreenProps<RootStackParamList, 'ServiceScreen'>;
...
export default function ServiceScreen({ navigation, route }: Props) {
  ...
  const [receiptPhotos, setReceiptPhotos] = useState<Asset[]>([]);
  ...
  const onSubmit = async (formData: ServiceFormData) => {
    ...
    try {
      ...
      const serviceType = validItems
        .map(serviceItem => serviceItem.type)
        .join(', ');
                ...
                <View style={tw.style('mb-4')}>
                  ...
                  <View
                    ...
                    <Input
                      ...
                      containerStyles={tw.style('flex-1 mb-0')}
                      textInputStyles={tw.style('border-0')}
                    />
                  </View>
                  {errors.odometerAtService && (
                    <Text
                ...
                <Controller
                  ...
                  render={({ field: { onChange, value } }) => (
                    <Input
                      ...
                      value={value}
                      onChangeText={onChange}
                      containerStyles={tw.style('mb-0 px-0')}
                      textInputStyles={tw.style(
                        'border-0 border-b border-darkGrey rounded-none',
                      )}
                    />
                  )}
                />
                  ...
                  render={({ field: { onChange, value } }) => (
                    <View style={tw.style('flex-row items-center px-4 py-3')}>
                      ...
                      <Input
                        ...
                        keyboardType="numeric"
                        containerStyles={tw.style('flex-1 mb-0')}
                        textInputStyles={tw.style('border-0 p-0')}
                      />
                    </View>
                  )}
                />
