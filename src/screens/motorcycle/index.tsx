...
type Props = StackScreenProps<RootStackParamList, 'MotorcycleScreen'>;
...
export default function MotorcycleScreen({ navigation }: Props) {
  ...
  const onSubmit = async (formData: MotorcycleFormData) => {
          ...
          <View style={tw.style('mx-6 mb-8 mt-4')}>
            {photo ? (
              ...
              <TouchableOpacity
                ...
                <Text
                  style={tw.style('text-grey font-montserrat text-sm mt-2')}>
                  Add Photo
                </Text>
              </TouchableOpacity>
            )}
